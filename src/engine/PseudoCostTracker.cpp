...
void PseudoCostTracker::initialize( List<PiecewiseLinearConstraint *> &plConstraints )
{
    ASSERT( _scores.empty() );
    ASSERT( _plConstraintToScore.empty() );
...
void PseudoCostTracker::updateScore( PiecewiseLinearConstraint *constraint, double score )
{
