...
{
public:
        AutoConstraintBoundTightener( const ITableau &tableau, BoundManager &boundManager )
	{
            _constraintBoundTightener = T::createConstraintBoundTightener( tableau, boundManager );
	}
