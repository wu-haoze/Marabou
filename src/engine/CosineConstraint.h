...
#ifndef __CosineConstraint_h__
#define __CosineConstraint_h__
...
class CosineConstraint : public TranscendentalConstraint
{
public:
    CosineConstraint( unsigned b, unsigned f );
    CosineConstraint( const String &serializedCosine );
    ...
    */
    ...
    /*
      Returns string with shape: cosine, _f, _b
    */
    ...
    */
    ...
    /*
      Compute the inverse of the cosine function.
    */
    static double cosineInverse( double y );

    /*
      Compute the derivative of the cosine function.
    */
    static double cosineDerivative( double x );

    static void findRangeOfCosOutput( double lb, double ub,
                                      double &newLb, double &newUb );
