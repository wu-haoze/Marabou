...
const double GlobalConfiguration::PROBABILITY_DENSITY_PARAMETER = 0.1;
...
const double GlobalConfiguration::RELU_CONSTRAINT_COMPARISON_TOLERANCE = 0.0000000001;
const double GlobalConfiguration::ABS_CONSTRAINT_COMPARISON_TOLERANCE = 0.0000000001;
...
const bool GlobalConfiguration::LOCAL_SEARCH_LOGGING= true;
